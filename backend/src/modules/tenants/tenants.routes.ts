...
import { createTenant, assignTenant, vacateTenant, getOccupancyDashboard, listTenants, addAndAssignTenant } from './tenants.controller';
...
router.post('/add-assign', addAndAssignTenant as any);
